    ...
    VkDeviceSize                                scratchOffset)
{
  ...
  return call(commandBuffer, pInfo, instanceData, instanceOffset, update, dst, src, scratch, scratchOffset);
}
    ...
    VkCopyAccelerationStructureModeNV           mode)
{
  ...
  return call(commandBuffer, dst, src, mode);
}
    ...
    uint32_t                                    firstQuery)
{
  ...
  return call(commandBuffer, accelerationStructureCount, pAccelerationStructures, queryType, queryPool, firstQuery);
}
